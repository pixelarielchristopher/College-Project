...
def should_add_new_data():
    ...
    expected_data = [[{'name': 'Aaron', 'yob': '2003', 'phone_no': '08123456789'}, None, None, None],
                     [None, None, None, None],
                     [None, None, None, None],
                     [None, None, None, None]]
...
def should_add_new_data_and_resize():
    ...
    expected_data = [
        ['Content', 'Content', 'Content', 'Content', {'name': 'Aaron', 'yob': '2003', 'phone_no': '08123456789'}, None,
         None, None],
...
def should_return_data_with_v_and_h_index():
    temporaryArray = [[None, None, None, None],
                      [None, None, None, None],
                      [{'name': 'Chris', 'yob': '2003', 'phone_no': '08123456789'}, None, None, None],
                      [None, None, None, None]]
    ...
    assert ((expected_v, expected_h), expected_phone_no_taken) == ((v, h),
                                                                   phone_no_taken), f"Expected Phone Number: {expected_phone_no_taken} in Vertical Index: {expected_v}, Horizontal Index: {expected_h} and got {phone_no_taken} in Vertical Index: {v}, Horizontal Index: {h}."
...
def should_get_new_horizontal_array_with_new_length_2times_after_insert():
    array_inside = [['Content', 'Content', 'Content', 'Content'],
                    ['Content', 'Content', 'Content', 'Content'],
                    ['Content', 'Content', 'Content', 'Content'],
                    ['Content', 'Content', 'Content', 'Content']]
    newSize_array = len(array_inside) * 2
    ...
    newArray_inside = append(array_inside, data)
    expected_newArray_inside = array_inside = [
        ['Content', 'Content', 'Content', 'Content', {'name': 'Aaron', 'yob': '2003', 'phone_no': '08123456789'}, None,
         None, None],
        ['Content', 'Content', 'Content', 'Content'],
        ['Content', 'Content', 'Content', 'Content'],
    ...
    assert expected_newArray_inside[0] == newArray_inside[
        0], f"Expected {expected_newArray_inside} and got {newArray_inside}."


def after_insert_should_return_telephoneBook_array_with_the_same_length_like_before_insert():
    temporaryArray = [[{'name': 'Agung', 'yob': '2003', 'phone_no': '08123456789'},
                       {'name': 'Agung', 'yob': '2003', 'phone_no': '08123456789'},
                       {'name': 'Agung', 'yob': '2003', 'phone_no': '08123456789'}, None],
                      [None, None, None, None],
                      [None, None, None, None],
                      [None, None, None, None]]
    ...
    expected_data = [[{'name': 'Agung', 'yob': '2003', 'phone_no': '08123456789'},
                      {'name': 'Agung', 'yob': '2003', 'phone_no': '08123456789'},
                      {'name': 'Agung', 'yob': '2003', 'phone_no': '08123456789'},
                      {'name': 'Abigail', 'yob': '2003', 'phone_no': '08911111111'}],
                     [None, None, None, None],
                     [None, None, None, None],
                     [None, None, None, None]]
    ...
    while True:
        ...
        if choise == '1':
            while True:
                ...
                if len(data['name']) != 0 and len(data['yob']) != 0 and data['yob'].isdigit():
                    check = check_duplicates(telephoneBook_array, data)
                    if check == True:
                        data['phone_no'] = input("Phone Number  : ")
                        if len(data['phone_no']) != 0 and data['phone_no'].isdigit():
                            (v, condition) = is_full(telephoneBook_array, data)
                            telephoneBook_array = append(telephoneBook_array, data)
                            break
                        else:
                            print("\n\033[1;31mSome attribute missing/\nmistakenly written!\033[0;0m")
                    if check == False:
                        print("Phone Number  : \033[1;31mData Already Exists!\033[0;0m")
                        print("------------------")
                        break
                else:
                    data['phone_no'] = input("Phone Number  : ")
                    if len(data['name']) == 0 and len(data['yob']) == 0 and len(data['phone_no']) == 0:
                        break
                    print("\n\033[1;31mSome attribute missing/\nmistakenly written!\033[0;0m")
        elif choise == '2':
            while True:
